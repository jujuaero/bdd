...
public class ArtworkController {
    ...
    private boolean showArtworkDialog(String title, Artwork artwork) {
        ...
        TextField priceField = new TextField(Double.toString(artwork.getPrice()));
        ...
        double price;
        try {
            price = Double.parseDouble(priceField.getText() == null ? "0" : priceField.getText().trim());
        } catch (NumberFormatException e) {
            showError("Validation", "Price must be numeric.");
            return false;
        }
